...
* [Valkey bundle release](https://valkey.io/blog/valkey-bundle-one-stop-shop-for-low-latency-modern-applications/): which brought together the modules
...
* Making Valkey easier to run, scale, manage, and observe,
* Better utilizing existing infrastructure to take advantage of modern CPUs with multi-threading and higher performance,
