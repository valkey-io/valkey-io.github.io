...
Until now, Valkey Search focused on vector similarity, enabling a wide range of workloads such as semantic search and AI workloads (see [launch blog](https://valkey.io/blog/introducing-valkey-search/)). 
...
Get Involved: Join the Valkey Search community, file issues, open pull requests, or suggest improvements. We welcome contributions of all kinds - code, documentation, testing, and feedback. Your involvement helps make Valkey Search better for everyone. [Get involved on GitHub](https://github.com/valkey-io).
