...
* [redlock-universal](https://github.com/alexpota/redlock-universal) (NodeJS implementation). Supports node-redis, ioredis, and Valkey GLIDE. Features auto-extension and batch acquisition.
