---
title: "XREAD"
description: "XREAD command reference documentation"
---
...
we recommend to read [our introduction to Streams](../topics/streams-intro.md).
...
Reading the [Streams introduction](../topics/streams-intro.md) is highly
