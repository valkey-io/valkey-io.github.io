---
title: "CLUSTER MEET"
description: "CLUSTER MEET command reference documentation"
---

`CLUSTER MEET` is used in order to connect different Valkey nodes with cluster
...
composing a Valkey Cluster, there are only two ways:
